     ...
     <!-- partial -->
            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Live Ranking @if($lombas != null) {{ $lombas->nama }} @endif</h4>
                          ...
                          <table class="table">                                                
                            <tbody>  
                              ...
                              <tr>
                                ...
                                <td style="width:25%" class="font-weight-bold text-right"><h3> @if($peserta_->nilai == -1) {{ "BELUM" }} @else {{ round($peserta_->nilai, 2) }} @endif </h3></td>
                              </tr>
                              @endforeach
                            </tbody>                      
                          </table> 
